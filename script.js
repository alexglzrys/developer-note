  ...
  methods: {
    ...
    addNote() {
      ...
      const note = {
        id: String(time),
        title: "Nueva nota",
        content: `**Hola estimado programador**

Esta es una nueva nota que usa el lenguaje [markdown](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) para su correspondiente formateado

- Sirvase en usar el editor para cambiar su contenido
- La función de auto-guardado salvará los cambios de cada nota
- Marque sus notas como favoritas`,
        created: time,
        favorite: false
      };
    ...
    removeNote() {
      if (
        this.selectedNote &&
        confirm("¿Desea eliminar la nota seleccionada?")
      ) {
  ...
  computed: {
    ...
    addButtonTitle() {
      return this.notes.length
        ? this.notes.length + " notas añadidas"
        : "0 notas añadidas";
    },
    selectedNote() {
